...
local ENEMIES = {
	...
	fungloom = { id = "fungloom", name = "Fungloom", sprite = "enemy_2.png", maxHP = 40, damageMin = 3, damageMax = 4, spriteScale = 3, scaleMul = 1 },
	fawn = { id = "fawn", name = "Fawn", sprite = "enemy_3.png", maxHP = 30, damageMin = 2, damageMax = 3, spriteScale = 4, scaleMul = 1 },
